...
INSERT INTO "new_Refund" ("amountPaise", "approvedAt", "approvedById", "createdAt", "errorCode", "errorDescription", "failedAt", "id", "isFullRefund", "orderId", "paymentId", "processedAt", "providerRefundId", "rawResponseJson", "reason", "reasonNote", "refundNumber", "requestedById", "requestedByType", "restockRequested", "restockedAt", "speed", "status", "updatedAt", "version") SELECT "amountPaise", "approvedAt", "approvedById", "createdAt", "errorCode", "errorDescription", "failedAt", "id", "isFullRefund", "orderId", "paymentId", "processedAt", "providerRefundId", "rawResponseJson", "reason", "reasonNote", "refundNumber", "requestedById", "requestedByType", "restockRequested", "restockedAt", "speed", "status", "updatedAt", "version" FROM "Refund";
DROP TABLE "Refund";
