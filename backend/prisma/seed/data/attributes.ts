...
export const ATTRIBUTES: SeedAttribute[] = [
  ...
  {
    code: 'PACK_SIZE',
    name: 'Pieces in the set',
    groupCode: 'DIMENSIONS',
    inputType: 'SELECT',
    dataType: 'NUMBER',
    isVariantDefining: true,
    values: [
      value('Single', { numericValue: 1 }),
      value('Set of 2', { numericValue: 2 }),
      value('Set of 3', { numericValue: 3 }),
      value('Set of 4', { numericValue: 4 }),
      value('Set of 5', { numericValue: 5 }),
      value('Set of 6', { numericValue: 6 }),
    ],
  },
  {
    ...
    helpText: 'The furniture an accessory is made for.',
    values: [
      value('Sofa'),
      value('Chair'),
      value('Table'),
