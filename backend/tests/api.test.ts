...
describe('OpenAPI (R7)', () => {
  it('documents every endpoint shipped so far', async () => {
    ...
    expect(Object.keys(response.body.paths).sort()).toStrictEqual([
      ...
      '/api/v1/admin/catalog/categories/{id}/products',
      '/api/v1/admin/catalog/categories/{id}/products/reorder',
      '/api/v1/admin/catalog/collections/{id}/restore',
      '/api/v1/admin/catalog/export/{entity}',
      '/api/v1/admin/catalog/import/{entity}',
      '/api/v1/admin/catalog/products',
      '/api/v1/admin/catalog/products/{id}/publish',
      '/api/v1/admin/catalog/products/{id}/relations',
      ...
      '/api/v1/admin/catalog/products/{id}/variants/{variantId}',
      '/api/v1/admin/catalog/products/{id}/variants/{variantId}/set-default',
      '/api/v1/admin/catalog/settings',
